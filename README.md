...
## 🧠 Technical Implementation (Simple Explanation)
...
✔ List sorting and filtering logic  
✔ Dialog-based preview UI  
✔ Custom theming with pastel color palette  
✔ Basic software architecture inside a single-file project  

The project is intentionally kept simple using single-file structure for learning purposes.

---

## 🚀 Future Improvements

Some possible upgrades for the app:
...
Flutter project developed for learning and portfolio showcase.

---

## 📄 License

This project is mainly for educational and portfolio demonstration purposes.
